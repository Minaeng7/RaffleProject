...
<!-- Start Top Search -->
    ...
    <input type="hidden" name="per_price" value="${rdto.per_price }">
                    ...
                    <div class="checkout-address">
                        <div class="title-left">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="" id="post" name="" value="${login.post }" style="border: 1px solid #e8e8e8" readonly><br>
                                <input type="text" class="" id="address1" name="" value="${login.addr1 }" style="border: 1px solid #e8e8e8" readonly>
