			...
			<div class="row">
				<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
					<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
						...
						<form action="UpdateMyRaffleSS" class="tm-edit-product-form">

							<input type="hidden" name="sell_rno" value="${sellrdto.sell_rno}">
							...
							<div class="row tm-edit-product-row">
								...
								<div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
									<div class="form-group mb-3">
										<label for="name">Raffle name</label> <input id="name"
											name="rafflename" type="text" value = "${sellrdto.rafflename}"class="form-control validate"
											required />
									</div>
									<div class="form-group mb-3">
									...
									<div class="row">
										...
										<div class="form-group mb-3 col-xs-12 col-sm-6">
											<label for="stock">Raffleamount</label> <input id="stock"
												name="raffleamount" type="text" value = "${sellrdto.raffleamount}"
